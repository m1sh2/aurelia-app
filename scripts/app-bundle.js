define('app',["require", "exports", "./todo", "./storage.service"], function (require, exports, todo_1, storage_service_1) {
    ...
    var App = (function () {
        function App() {
            ...
            this.todos = storage_service_1.storage.get('todos') || [];
            this.todoDescription = '';
            this.todoType = 'story';
            if (!storage_service_1.storage.get('todos')) {
                storage_service_1.storage.set('todos', JSON.stringify([
        ...
        App.prototype.addTodo = function () {
            if (this.todoDescription) {
                ...
                storage_service_1.storage.set('todos', this.todos);
                this.todoDescription = '';
                this.todoType = 'story';
            }
        };
...
//# sourceMappingURL=data:application/json;charset=utf8;base64,
